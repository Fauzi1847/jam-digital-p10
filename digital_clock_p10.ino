 ...
 * ******************** https://github.com/fahrudinafif89/jam-digital-p10 ********************
 * *************** atau lebih lengkapnya lagi klik:https://youtu.be/ULKmqvRXUJQ***************
 * 
 * arduino A5 >> SCL DS3231
 *         A4 >> SDA DS3231
 *untuk koneksi arduino ke led matrix p10 menggunkan connector jadi tinggal pug and play
 */
